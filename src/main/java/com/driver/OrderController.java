...
public class OrderController {
    ...
    public ResponseEntity<String> addOrder(@RequestBody Order order){                            //1
            orderService.addOrder(order);
        return new ResponseEntity<>("New order added successfully", HttpStatus.CREATED);
    }

    @PostMapping("/add-partner/{partnerId}")
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){                     //2
    ...
    public ResponseEntity<List<String>> getAllOrders(){
        List<String> orders = orderService.getAllList();
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        Integer countOfOrders = orderService.getCountLeftGivenTime(time,partnerId);
